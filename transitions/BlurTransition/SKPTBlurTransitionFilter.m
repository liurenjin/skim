...
#import "SKPTBlurTransitionFilter.h"
#import <Foundation/Foundation.h>
#import <ApplicationServices/ApplicationServices.h>

@implementation SKPTBlurTransitionFilter
...
- (CIImage *)outputImage
{
    ...
    [blurFilter setValue:[NSNumber numberWithFloat:50.0 * (0.5 - fabs(0.5 - t))] forKey:@"inputRadius"];
